...
function applyTheme(){var t=(db.settings&&db.settings.theme)||"dark";document.documentElement.className=t==="light"?"light":"";var m=document.querySelector('meta[name="theme-color"]');if(m)m.setAttribute("content",t==="light"?"#fafafa":"#000000")}
...
function pickPfp(){var f=$("#pfp");if(!f||!f.files||!f.files[0])return;var r=new FileReader();r.onload=function(){me().pic=r.result;save(db);sheet="edit";draw()};r.readAsDataURL(f.files[0])}
